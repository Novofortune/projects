...
function send_email($listingID){
	$SendTo = "hzrtnt018@gmail.com";
	$SendTo1 = "support@first2move.com";
	$url = "smtp.126.com";
	$port = 25;
	...
	send_mail($subject,$content,$SendTo,$url,$port,$user,$pass,$user_name);
	//echo 'sent';
	send_mail($subject,$content,$SendTo1,$url,$port,$user,$pass,$user_name);
}

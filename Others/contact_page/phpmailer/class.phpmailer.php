...
{
	//Some Custom Code--------------------------
	static function send_mail($subject,$content,$SendTo,$host_url,$port,$user,$pass,$preferred_sender_name){
		$mail             = new self();
		$body             = $content;
		...
		$mail->SetFrom($user, $preferred_sender_name);
		$mail->AddReplyTo($user, $preferred_sender_name);
		$mail->Subject    = $subject;
		$mail->MsgHTML($body);
		$address = $SendTo;
		$mail->AddAddress($address, $preferred_sender_name);
		if(!$mail->Send()) {
